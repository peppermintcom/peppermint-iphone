 ...
 */
- (NSString *)table:(WKInterfaceTable *)table rowIdentifierAtIndexPath:(IGTableRowData *)indexPath;
 ...
 */
- (void)table:(WKInterfaceTable *)table didSelectRowAtIndexPath:(IGTableRowData *)indexPath;
